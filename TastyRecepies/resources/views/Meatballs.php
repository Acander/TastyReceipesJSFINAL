...
<html>
	<head>
		...
		<script type="text/javascript" src="../javaScript/setComment.js"></script>
		<script type="text/javascript" src="../javaScript/getComment.js"></script>
		<script type="text/javascript" src="../javaScript/delComment.js"></script>
	</head>
